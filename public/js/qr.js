...
(function(){
  ...
  async function showConnectionSuccessWithDetails(instName) {
    ...
    const go = () => {
try { if (window.qrFlowLog) window.qrFlowLog('qr.flow.redirect_start', { source: 'qr.js', target: '/dashboard', instName }); } catch (_) {}
...
if (goBtn) { goBtn.style.display = ''; goBtn.onclick = () => { window.location.href = '/dashboard'; }; }
